...
* [Папка с выполнением](additional_tasks/additional_nested_omp/)
* [Скриншоты запуска](additional_tasks/additional_nested_omp/README.md)
...
* [Папка с выполнением](additional_tasks/additional_untied_tasks/)
* [Скриншоты запуска](additional_tasks/additional_untied_tasks/README.md)
...
* [Папка с выполнением](additional_tasks/additional_matrix/)
* [Скриншоты запуска](additional_tasks/additional_matrix/README.md)
...
* [Папка с выполнением](additional_tasks/additional_sort/)
* [Скриншоты запуска](additional_tasks/additional_sort/README.md)
